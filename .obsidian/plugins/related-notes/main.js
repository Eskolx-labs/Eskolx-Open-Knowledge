...
function port() {
  if (!channel) {
    ...
    channel.port1.onmessage = () => {
      var _a;
      return (_a = pending.shift()) == null ? void 0 : _a();
    };
  }
...
var TimeSlicer = class {
  constructor(budgetMs = DEFAULT_SLICE_BUDGET_MS) {
...
var SingleBloomFilter = class {
   ...
   */
  addPreparedTokens(tokens, start = 0, end = tokens.length) {
